...
<html lang="en">
    <head>
        ...
        <title>Данила Баранов</title>
        <link rel="shortcut icon" href="./img/ico.png" type="image/png">
        <link rel="stylesheet" href="/var/www/html/public/static/css/reset.css">
        <link rel="stylesheet" href="/var/www/html/public/static/css/style.css">
    </head>
<div class="wrapper">
<header class="header">
